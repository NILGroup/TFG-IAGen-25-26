...
- **Evaluación con usuarios reales** — SofIA todavía no ha sido evaluada con personas con discapacidad intelectual, por lo que su eficacia práctica está pendiente de validación.
- **Verificación de fuentes** — Las respuestas generadas no cuentan aún con un mecanismo de verificación que garantice su fiabilidad.
- **Persistencia** — El historial, los favoritos y el glosario viven en memoria de sesión; no hay backend ni autenticación de usuarios.
